...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('message').setDescription('The message you want the other person to say').setRequired(true)),
    ...
    async execute(interaction) {
        ...
        await interaction.reply({ content: `${member} has been impersonated below!`, ephemeral: true });
    }
}